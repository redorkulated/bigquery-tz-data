...
|---------|-----------------|------------|------------|----------|--------------|
| 2024a   | tz-data         | [release_2024a_EU](https://console.cloud.google.com/bigquery?page=table&p=tz-data&d=release_2024a_EU&t=timezones) | [release_2024a_US](https://console.cloud.google.com/bigquery?page=table&p=tz-data&d=release_2024a_US&t=timezones) |     Y    |              |
